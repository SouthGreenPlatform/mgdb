...
public interface BrapiService
{
	...
	@FormUrlEncoded
	@POST("markers")
	Call<BrapiListResource<BrapiMarker>> getMarkerInfo(@Field("name") Set<String> name, @Field("matchMethod") String matchMethod, @Field("include") String include, @Field("type") String type, @Field("pageSize") String pageSize, @Field("page") String page);
