...
public class MgdbDao extends Helper
{
	 ...
	 * @throws Exception the exception
	 */
	private static LinkedHashMap<VariantData, Collection<VariantRunData>> getSampleGenotypes(MongoTemplate mongoTemplate, ArrayList<String> variantFieldsToReturn, HashMap<Integer, ArrayList<String>> projectIdToReturnedRunFieldListMap, List<Comparable> variantIdListToRestrictTo, Sort sort) throws Exception
	{
...
//		query.with(sort == null ? new Sort(Direction.ASC, "_id") : sort);
	 ...
	 * @throws Exception the exception
	 */
	public static LinkedHashMap<VariantData, Collection<VariantRunData>> getSampleGenotypes(MongoTemplate mongoTemplate, List<SampleId> sampleIDs, List<Comparable> variantIdListToRestrictTo, boolean fReturnVariantTypes, Sort sort) throws Exception
	{
